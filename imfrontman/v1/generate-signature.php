...
<section class="half">
    ...
    <form action="" method="POST">
        ...
        <input type="text" name="file-url" value="" placeholder="Zadejte adresu obrázku" required></br>
...
<ol>
    ...
    <li>CONTROL + A , CONTROL + C</li>
    <li><strong>V outlooku</strong>
        <ol>
            <li>Nový email</li>
            <li>Karta "Zpráva" -> Podpis</li>
            <li>Podpis e-mailu -> Nový</li>
            <li>CONTROL + V do pole "Upravit podpis"</li>
            <li>Uložit, nastavit nový podpis na "Nové zprávy" a "Odpovědi a předané zprávy"</li>
        </ol>
    </li>
    <li><strong>Starší verze outlooku</strong>
        <ol>
            <li>Stažený .htm soubor s podpisem vložit do složky - Users/[Uživatelské jméno]/AppData/Roaming/Microsoft/Signatures (skrytá složka, nutno povolit zobrazování skrytých adresářů)</li>
            <li>Nový email</li>
            <li>Karta "Zpráva" -> Podpis</li>
            <li>Nastavit nový podpis na "Nové zprávy" a "Odpovědi a předané zprávy"</li>
    </li>
</ol>
</li>
</ol>
